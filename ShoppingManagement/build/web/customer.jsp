                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    ...
                                    <button type="button" class="btn btn-outline-primary ms-1" onclick="location.href = 'MainController?action=Shopping_Page'">Shopping</button>
                                    <button type="button" class="btn btn-secondary ms-1" onclick="location.href = 'updateUser.jsp'">Edit</button>
                                </div>
                            </div>
                        </div>
